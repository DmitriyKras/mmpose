...
from mmpose.datasets import (CocoDataset, GenerateTarget, GetBBoxCenterScale,
                             ...
                             RandomHalfBody, TopdownAffine, RatPoseDataset, TopViewRodentsDataset)
...
# runtime
train_cfg.update(max_epochs=200, val_interval=20)
...
dataset_type = TopViewRodentsDataset
data_mode = 'topdown'
data_root = '/home/cv-worker/dmitrii/RAT_DATASET/TopViewRodents_COCO/'
